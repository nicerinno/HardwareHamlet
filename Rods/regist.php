...
<section class="">
    ...
    <div class="container container2 roundCorner" style="margin-top: 20px">
        <form method="post" accept-charset="ISO-8859-1" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div style="margin-bottom: 10px">
                ...
                <div class=" form-group" >
                    ...
                    <input class="form-control"  type="password" name="re_password" value="<?php echo $re_password; ?>">
                </div>

                <p><span class="error">* Preenchimento obrigatório</span></p>

                <input style="margin:auto; display: block" class="btn" type="submit" name="submit" id="submit" value="Registar">
                <br>
            </div>
        </form>
    </div>
    ...
    if (isset($_POST['submit']) && $usernameErr=="" && $passwordErr=="" && $emailErr=="" && $re_passwordErr=="")
    {
        ...
        $regist = $nuser->register();
        //TODO: página a confirmar o registo
        if($regist = "Registo efectuado com sucesso. Confirma o teu registo no seu email."){
            echo "<script> location.href='confirmationPage.php?email=$email';</script>";
