	...
	<head>
		...
		<body style="background-color: #3B4568">
		<header id="header">
        ...
        <section class="home-about-area align-content-center">
            ...
            <div class="container container2 roundCorner" style="margin-top: 20px; margin-bottom: 20px">
                    ...
                    <div  class="align-content-center">
                        ...
                        $nc = new Users("", "", "", "", "","", "", "", "","","");
                        $result = $nc->query_user_rank();

                        echo "<br>";

                        if ($result->num_rows > 0) {
                            // output data of each row
                            echo "<table class='table table-striped' style='border:2px solid; border-collapse: collapse; color: white'>";
                            echo "<thead>";
                            echo "<tr>
								<th name='username' scope='col' style='border:4px solid; padding:10px; color: white'>Nome</th>
								<th name='title_id' scope='col' style='border:4px solid; padding:10px; color: white'>Titulo</th>
								<th name='reputation' scope='col' style='border:4px solid; padding:10px; color: white'>Reputação</th>
							</tr>
							</thead>
							<tbody style=''>";

                            while ($row = $result->fetch_assoc()) {
                                $nc = new Users($row['title_id'], "", "", "", "","", "", "", "","","");
                                $title_id = $nc->query_title_by_id();
                                echo "<tr>",
                                "<td style='border:4px solid; padding:10px'>",$row['username'],"</td>",
                                "<td style='border:4px solid; padding:10px;'>",$title_id,"</td>",
                                "<td style='border:4px solid; padding:10px;'>",$row['reputation'],"</td>",
