				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="products.html"> Top Utilizadores</a></p>
						</div>	
					</div>
				</div>
			</section>
            ...
            <div class="container" style="background-color: #eeeeee;margin-top: 20px; margin-bottom: 20px">
                    ...
                    <div  class="align-content-center">
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<thead>";
                            echo "<tr>
								<th name='username' scope='col' style='border:4px solid; padding:10px;'>Nome</th>
								<th name='title_id' scope='col' style='border:4px solid; padding:10px;'>Titulo</th>
								<th name='reputation' scope='col' style='border:4px solid; padding:10px;'>Reputação</th>
							</tr>
							</thead>
							<tbody style=''>";
