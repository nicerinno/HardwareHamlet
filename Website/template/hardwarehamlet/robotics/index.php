            ...
            <div class="container">
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        ...
                        <p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="index.php">Home</a></p>
			...
			<section class="home-about-area">
				<div class="container" style="margin: 50px">
					<div class="row align-items-center">
						<div class="col-lg-5 home-about-left" style="background-color: #00aceb">
						...
						<div class="col-lg-7 home-about-right ">
                            <img class="mx-auto d-block" height="500px" width="700px" style="padding-left: 100px" src="img/icon.png" alt="">
                        </div>
