				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="ver-componentes.php"> Componentes</a></p>
						</div>	
					</div>
				</div>
			</section>
			...
			<section class="home-about-area" >
				<div class="container" >
					<div class="row" style="height:500px">
						...
						<div  id="table_div" class="col-md-7" style= 'background: #fff; height:500px' >
							<h4 style="text-align: center">Componentes disponiveis</h4>
							<table class='table table-striped' style='border:2px solid; border-collapse: collapse;  '>
								<thead>
								<tr >
									<th name='name' scope='col' style='border:4px solid; padding-left:10px;'>Name</th>
